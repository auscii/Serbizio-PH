...
<head>
    ...
    <title>Company Signup Form | Serbizio Instant Services</title>
...
<div class="container">
    ...
    <h1 class="form-title">Register With Us</h1>
    ...
    <?php endif; ?>
<form id="signupForm" enctype="multipart/form-data" action="register.php" method="POST">

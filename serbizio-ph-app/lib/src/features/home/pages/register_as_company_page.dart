...
import 'package:serbizio_ph/src/features/authentication/controllers/register_individual_controller.dart';
...
class RegisterAsCompanyPage extends StatelessWidget {
  const RegisterAsCompanyPage({super.key});
...
class RegisterFormWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(RegisterIndividualController());
